...
public class ChoucairAcademyStepDefinitions {
    ...
    public void thanJhonatanWantsToLearnAutomationAtTheAcademyChoucair(List<AcademyChoucairData> academyChoucairData) throws Exception {
        OnStage.theActorCalled("Jhonatan").wasAbleTo(OpenUp.thePage(), Login.
